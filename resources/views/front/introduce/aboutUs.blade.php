...
@section('body')
                ...
                <div class="col-12">
                    <figure>
                        <div class="about_thumb">
                            <img src="front/img/about/IMG_3398.JPG" alt="">
                        </div>
                        <figcaption class="about_content">
                            ...
                            <div class="about_signature">
                                <img src="front/img/about/about-us-signature.png" alt="">
                            </div>
                        </figcaption>
                    </figure>
                </div>
    ...
    <!--chose us area start-->
    <div class="choseus_area" data-bgimg="front/img/about/about-us-policy-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="front/img/about/About_icon1.png" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="front/img/about/About_icon2.png" alt="">
                        </div>
                        <div class="chose_content">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="front/img/about/About_icon3.png" alt="">
                        </div>
                        <div class="chose_content">
